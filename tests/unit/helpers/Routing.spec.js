...
describe('Routing::toField', () => {
    it('Url does not go to iframe', () => {
        expect(toField({
            ...
            match: 'asd',
            year: '2020',
        }, 'uitslagen', 'HE 1x')).toBe('/asd/2020/uitslagen/HE 1x')
    });
    it('Url goes to iframe', () => {
        expect(toField({
            ...
            match: 'asd',
            year: '2020',
        }, 'uitslagen', 'HE 1x')).toBe('/iframe/asd/2020/uitslagen/HE 1x')
    });
...
describe('Routing::openPage', () => {
    ...
    it('Stay on uitslagen', () => {
        ...
        expect(pushSpy.mock.calls[0][0]).toEqual({path: '/iframe/ww/2920/uitslagen/HE 1x'});
    });
    it('Stay on loting', () => {
        router.currentRoute.params = {
            match: 'ww',
        ...
        expect(pushSpy).toHaveBeenCalled();
        expect(pushSpy.mock.calls[0][0]).toEqual({path: '/iframe/ww/2920/loting/HE 1x'});
    });
