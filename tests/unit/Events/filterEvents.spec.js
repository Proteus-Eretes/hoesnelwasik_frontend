...
describe('Events are filtered correctly', () => {
    it('Filter on man - isLight', () => {
        ...
        expect(filterEvents(events('X 1x'), true, true)).toEqual([
            {
                id: 1,
                isman: true,
                islight: true,
    ...
    it('Filter on man', () => {
        const fieldnameshort = 'X 1x';
        expect(filterEvents(events('X 1x'), true, false)).toEqual([
            {
                id: 2,
                isman: true,
                islight: false,
    ...
    it('Filter on woman - isLight', () => {
        const fieldnameshort = 'X 1x';
        expect(filterEvents(events('X 1x'), false, true)).toEqual([
            {
                id: 3,
                isman: false,
                islight: true,
    ...
    it('Filter on woman', () => {
        const fieldnameshort = 'X 1x';
        expect(filterEvents(events('X 1x'), false, false)).toEqual([
            {
                id: 4,
                isman: false,
                islight: false,
